...
export function SearchBar({
  ...
  return (
    <div className="flex w-full max-w-xl items-start gap-2">
      ...
      <SearchHelpButton
        title="Ayuda del buscador principal"
        description="Busca por titulo, tags y contenido. Tambien puedes usar prefijos para acotar lo que necesitas."
        items={[
          {
            title: 'Busqueda libre',
            description: 'Escribe palabras clave relacionadas con el titulo, las etiquetas o el contenido de las fichas.',
          },
          {
            title: '/cmd',
            description: 'Encuentra fichas con comandos, parametros y fragmentos reutilizables.',
          },
          {
            title: '/env',
            description: 'Filtra informacion de entornos, URLs, hosts, accesos y datos tecnicos.',
          },
          {
            title: '/db',
            description: 'Muestra contenido relacionado con SQL, tablas y base de datos.',
          },
          {
            title: '/uml y /task',
            description: 'Usa /uml para modelado y diagramas, y /task para procedimientos, pasos o checklists.',
          },
        ]}
      />
    </div>
